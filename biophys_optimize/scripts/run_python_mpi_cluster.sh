...
export BPO_PATH=/data/informatics/mousecelltypes/biophys_optimize/biophys_optimize/

NEURON_HOME=/shared/utils.x86_64/nrn-7.4-1370
export PYTHONPATH=${NEURON_HOME}/lib/python:${ALLENSDK_PATH}:${ARGSCHEMA_PATH}:${MM_PATH}:${BPO_PATH}:${PYTHONPATH}
